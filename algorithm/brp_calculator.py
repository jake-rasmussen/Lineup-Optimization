def calculate_brp(stats1, stats2, stats3, stats4):
    """
    Calculate BRP for a 4-tuple of players using their stats dictionaries.
    
    Args:
        stats1, stats2, stats3, stats4: Dictionaries with keys:
            pa, h, 2b, 3b, hr, sb, bb, hbp, ibb
    ...
    Q104 = E113 = .66 #0X0/1
    R104 = E114 = .32 #0X0/2
    S104 = E115 = 1.44 #XX0/0
    T104 = E116 = .88 #XX0/1
    U104 = E117 = .43 #XX0/2
    V104 = E118 = 1.35 #00X/0
    W104 = E119 = .95 #00X/1
    X104 = E120 = .35 #00X/2
    Y104 = E121 = 1.78 #X0X/0
    Z104 = E122 = 1.13 #X0X/1
    AA104 = E123 = .48 #X0X/2
    AB104 = E124 = 1.96 #0XX/0
    AC104 = E125 = 1.38 #0XX/1
    AD104 = E126 = 0.58 #0XX/2
    AE104 = E127 = 2.29 #XXX/0
    AF104 = E128 = 1.54 #XXX/1
    AG104 = E129 = .75 #XXX/2
    I104 = 0 #EOI
    ...
    BRP = SUM(I108,I110,I111,I114,I116,I120,I122,J106,J109,J112,J115,J118,J121,J124,J127,K106,K107,K110,K113,K116,K119,K122,K125,L107,L108,L109,L110,L111,L114,L119,L120,M106,N107,N109,N119,O107,O108,O110,P109,P112,Q110,Q113,R111,R114,R116,S106,S109,S112,S115,S121,S124,T107,T109,T110,T116,T119,T122,T125,U108,U110,U111,U113,U120,U122,V106,V109,V112,V115,V118,V121,V124,V127,W107,W110,W112,W113,W116,W118,W119,W122,W125,X108,X111,X113,X114,X119,X120,X125,Y109,Y112,Y118,Z110,Z113,Z119,AA111,AA114,AA120,AB109,AB112,AC110,AC113,AD111,AD114,AD116,AD125,AF116,AF125
    )
    print("BRP:")
    print(BRP)
