...
def optimize_lineup(excel_file_path, players, constraints=None, bdnrp_csv=None, method='genetic', max_iterations=1000):
    ...
    # Delete the cached BDNRP file if it exists
    if bdnrp_csv and os.path.exists(bdnrp_csv):
        print(f"Deleting existing BDNRP cache file: {bdnrp_csv}")
        os.remove(bdnrp_csv)
    
    # Step 1: Generate or load BDNRP data
